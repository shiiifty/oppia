...
class CollectionProgressModel(base_models.BaseModel):
    ...
    def create(
        ...
        return cls(id=instance_id, user_id=user_id, collection_id=collection_id)
...
class StoryProgressModel(base_models.BaseModel):
    ...
    def create(cls, user_id: str, story_id: str) -> StoryProgressModel:
        ...
        return cls(id=instance_id, user_id=user_id, story_id=story_id)

    # Here we use MyPy ignore because the signature of this method
    # doesn't match with BaseModel.get_multi().
    @overload  # type: ignore[override]
    @classmethod
    def get(cls, user_id: str, story_id: str) -> StoryProgressModel: ...
    ...
    def get(
        ...
        """
        instance_id = cls._generate_id(user_id, story_id)
        return super(StoryProgressModel, cls).get(instance_id, strict=strict)
...
class UserContributionRightsModel(base_models.BaseModel):
    ...
    @classmethod
    def get_translation_reviewer_user_ids(cls, language_code: str) -> List[str]:
...
class LearnerGroupsUserModel(base_models.BaseModel):
    ...
    def delete_learner_group_references(
        ...
        for learner_grp_usr_model in found_models:
            ...
            learner_grp_usr_model.learner_groups_user_details = updated_details
